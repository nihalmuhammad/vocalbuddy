...
export const VOICES: VoiceOption[] = [
  { id: 'Zephyr', label: 'Zephyr', description: 'Clear & Professional' },
  { id: 'Kore', label: 'Kore', description: 'Bright & Energetic' },
  { id: 'Puck', label: 'Puck', description: 'Warm & Friendly' },
  { id: 'Charon', label: 'Charon', description: 'Deep & Authoritative' },
  { id: 'Fenrir', label: 'Fenrir', description: 'Strong & Resonant' },
];
